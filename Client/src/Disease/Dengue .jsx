    ...
    <div className=' bgcoll    main-containers  '>
      ...
      <div class='row'>
        <div className=' col bg-light rounded border border-danger vh-1 text-dark p-4'>
          <h4 className='border border-secondary bgcoll text-white rounded text-center'>Dengue fever patient information</h4>
        ...
        <div className='col-md-6 bg-light rounded p-0 border border-danger text-dark p-4 '>
          <h4 className='border border-secondary  rounded bgcoll text-white text-center'>Dengue fever Health Facility information</h4>
        ...
        <h4 className='border border-secondary bgcoll text-white text-center rounded '>Addis Ababa Public Health Emergency Managment Dengue fever Reporting Format</h4>
          <table className='Scrol-Table Scrol-Table table light padding table-responsive'>
            <tr className='border border-secondary'>
            <th>
                <div className='mb-5'>
