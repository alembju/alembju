...
function MaternalDeath () {
  ...
  const [TEthnicity,setTEthnicity]=useState("")
  ...
  const [WANC,setWANC]=useState('')
  const [NWANC,setNWANC]=useState('')
  const [GAANC,setGAANC]=useState('')
  const [Mode,setMode] =useState("")
  const [BabyBorn,setBabyBorn] = useState("")
  const [DBabyBorn,setDBabyBorn] = useState(new Date())
  const [Assisted, setAssisted]=useState('')
  const [PNC,setPNC]=useState()
  const [TPNC, setTPNC] = useState("")
  const [DirectCauseD,setDirectCauseD] = useState("")
  const [TDirectCauseD, setTDirectCauseD] = useState("")
  const [IndirectCauseD,setIndirectCauseD] = useState("")
  const [TIndirectCauseD, setTIndirectCauseD] = useState("")
...
///////////////////////////////////////////////////////////
  ...
  const [visitingA,setvisitingA]=useState(false)
...
const submitImage = async (e) => {
  ...
  formData.append("NWANC", NWANC);
  formData.append("WANC", WANC);
  formData.append("GAANC", GAANC);
  formData.append("Mode", Mode);
  formData.append("BabyBorn", BabyBorn);
  formData.append("DBabyBorn", DBabyBorn);
  formData.append("Assisted", Assisted);
  formData.append("PNC", PNC);
  formData.append("TPNC", TPNC);
  formData.append("DirectCauseD", DirectCauseD);
  formData.append("TDirectCauseD", TDirectCauseD);
  formData.append("IndirectCauseD", IndirectCauseD);
  formData.append("TIndirectCauseD", TIndirectCauseD);
  ...
  const result = await axios.post(
    "http://localhost:3000/MaternalDeath",
    formData,
    {
...
const  optionsdelivery  = [
  ...
  { label:  'TBA elderly', value:  'TBA elderly'  },
  { label:  'HEWs', value:  'HEWs'  },
  { label:  'HCWs', value:  'HCWs'  },
]
//////////////////////////////////////////multiple selection Cause of Death ////////////////////////

const  handleOnchangeCause  =  val  => {
  setDirectCauseD(val)
}
const  optionsCause  = [
  { label:  'Hemorrhage', value:  'Hemorrhage'  },
  { label:  'Obstructed labor', value:  'Obstructed labor'  },
  { label:  'HDP', value:  'HDP'  },
  { label:  'Abortion', value:  'Abortion'  },
  { label:  'Sepsis', value:  'Sepsis'  },
]

//////////////////////////////////////////multiple selection Indirect Cause of Death ////////////////////////

const  handleOnchangeIn  =  val  => {
  setIndirectCauseD(val)
}
const  optionsIn  = [
...
//////////////////////////////////////////multiple selection Delay 1 ////////////////////////

const  handleOnchangeD1  =  val  => {
  setIndirectCauseD1(val)
}
const  optionsD1  = [
  { label:  'AnTraditional Practicesemia', value:  'Traditional Practices'  },
  { label:  'Lack of decision to go to health facility', value:  'Lack of decision to go to health facility'  },
  { label:  'Family poverty', value:  'Family poverty'  },
  { label:  'Delayed referral from home', value:  'Delayed referral from home'  },
  { label:  'Failure of recognition of the problem', value:  'Failure of recognition of the problem'  },
]
//////////////////////////////////////////multiple selection Delay 2 ////////////////////////

const  handleOnchangeD2  =  val  => {
  setDelay2(val)
}
const  optionsD2  = [
  { label:  'Delayed arrival to referred health facility', value:  'Delayed arrival to referred health facility'  },
  { label:  'Lack of transportation', value:  'Lack of transportation'  },
  { label:  'Lack of roads', value:  'Lack of roads'  },
  { label:  'No facility within reasonable distance', value:  'No facility within reasonable distance'  },
]
//////////////////////////////////////////multiple selection Delay 3 ////////////////////////
                
                 

const  handleOnchangeD3  =  val  => {
  setDelay3(val)
}
const  optionsD3  = [
  { label:  'Delayed arrival to the next health facility from another facility on referral', value:  'Delayed arrival to the next health facility from another facility on referral'  },
  { label:  'delayed management after admission', value:  'delayed management after admission'  },
  { label:  'Human error or miss management', value:  'Human error or miss management'  },
  { label:  'Delayed or lacking supplies and equipment', value:  'Delayed or lacking supplies and equipment'  },
]
    ...
    <div className=' bgcoll    main-containers  '>
      ...
      <div class='row'>
        <div className=' col bg-light rounded border border-danger vh-1 text-dark p-4'>
          <h4 className='border border-secondary bgcoll text-white rounded text-center'>Maternal Death patient information</h4>
        ...
        <tr className='border border-secondary'>
         ...
         <div className='mb-2 form-check-inline'>
                ...
                <input type="Decimal" placeholder="ID" autoComplete="off" name="ID" value={ID} className='form-control justify-center rounded-lg w-70 text-3x1'
         ...
         <th>
              <div className='mb-2'>
                <h6><label htmlFor="email">Time of berth</label>
                  <input type="number" placeholder="Time" autoComplete="off" name="Time" value={Time} className='form-control justify-center rounded-lg w-70 text-3x1'
         ...
         <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Age at Death (Years)</label>
              ...
              <th>
                <div className='mb-2'>
                <h6> <label htmlFor="email">Residence of Deceased </label>
                  <select type="text" className='form-control rounded-2 w-70' value={Residence}  onChange={(e)=> setResidence(e.target.value)}>
              ...
              <div className='mb-2'>
                ...
                <select type="text" className='form-control rounded-3 w-70' value={Pdeath} onChange={(e)=>setPdeath(e.target.value)}  >
                <option value="" selected disabled >-- Select--</option>
                    ...
                    <option value="woreda 06">During transit from facility to facility</option>
              ...
              <div className='mb-2'>
                ...
                <select type="text" className='form-control rounded-3 w-70' value={PMarital} onChange={(e)=>setPMarital(e.target.value)}  >
                <option value="" selected disabled >-- Select--</option>
                    <option value="Single">Single</option>
                    <option value="Divorced">Divorced</option>
                    <option value="Married">Married</option>
                    <option value="Wodowed">Wodowed</option>
              ...
              <th>
                 <div className='mb-2'>
                    <h6><label htmlFor="email">Religion</label>
                       <select type="text" className='form-control rounded-3 w-70' value={Religion} onChange={(e) => (handleshowhide(e), setReligion(e.target.value))}>
                       <option value="" selected disabled >-- Select--</option>
                    ...
                    <div className="col-md-10 form-group">
                        ...
                        <input type="text" placeholder="Religion.." autoComplete="off" name="Religion" value={TReligion} className='form-control justify-center rounded-lg w-70 text-3x1'
                 ...
                 <th>
                 <div className='mb-2'>
                    <h6><label htmlFor="email">Ethnicity</label>
                       <select type="text" className='form-control rounded-3 w-70' value={Ethnicity} onChange={(e) => (handleshowhide(e), setEthnicity(e.target.value))}>
                       <option value="" selected disabled >-- Select--</option>
                       <option value="Amhara">Amhara</option>
                       <option value="Oromo ">Oromo </option>
                      <option value="Tigraway">Tigraway</option>
                     <option value="Somali">Somali</option>
                     <option value="Guragie">Guragie</option>
                     <option value="Sidama">Sidama</option>
                       <option value="Welaita ">Welaita </option>
                      <option value="Afar">Afar</option>
                     <option value="Hadiya">Hadiya</option>
                     <option value="Gamo">Gamo</option>
                     <option value="Gedeo">Gedeo</option>
                       <option value="Keffa ">Keffa </option>
                      <option value="Kembata">Kembata</option>
                     <option value="Agew/Awingi ">Agew/Awingi </option>
                     <option value="Kulo">Kulo</option>
                     <option value="Goffa">Goffa</option>
                       <option value="Bench ">Bench </option>
                      <option value="Kemant">Kemant</option>
                     <option value="Yemsa">Yemsa</option>
                     <option value="Agew/Kamyr ">Agew/Kamyr </option>
                     <option value="Ari">Ari</option>
                       <option value="Konso ">Konso </option>
                      <option value="Alaba">Alaba</option>
                     <option value="Gumuz">Gumuz</option>
                     <option value="Jebelawa">Jebelawa</option>
                     <option value="Koyra">Koyra</option>
                       <option value="Somalis ">Somalis </option>
                      <option value="Hamer">Hamer</option>
                     <option value="Shinasha">Shinasha </option>
                    ...
                    {showhide === '4' && (
                    <div className="col-md-10 form-group">
                        <h6> <label htmlFor="email">If other, Ethnicity</label></h6>
                        <input type="text" placeholder="Ethnicity.." autoComplete="off" name="Ethnicity" value={TEthnicity} className='form-control justify-center rounded-lg w-70 text-3x1'
                             onChange={(e) => setTEthnicity(e.target.value)} />
                             </div>
                      )}
                 </th>
              ...
              <th>
                 ...
                 <select type="text" className='form-control rounded-3 w-70' value={Educational} onChange={(e) =>  setEducational(e.target.value)}>
                 <option value="" selected disabled >-- Select--</option>
                 <option value="No Formal education">No Formal education</option>
                 <option value="No formal education but can read and write">No formal education but can read and write</option>
                ...
                <th>
                <div className='mb-2'>
                <h6><label htmlFor="email"> Gravidity</label>
                  <input type="number" placeholder=" Gravidity" autoComplete="on" name="Gravidity" value={Gravidity} className='form-control justify-center rounded-lg w-70 text-3x1'
                    onChange={(e) => setGravidity(e.target.value)} /></h6>
                </div>
              </th>
              </tr>
              <tr className='border border-secondary'>
              <th>
                ...
                <h6><label htmlFor="email"> Parity</label>
                  <input type="number" placeholder=" Parity" autoComplete="on" name="Parity" value={TParity} className='form-control justify-center rounded-lg w-70 text-3x1'
                    onChange={(e) => setTParity(e.target.value)} /></h6>
                </div>
              </th>
              <th>
              <div className='mb-2'>
                <h6><label htmlFor="email">Timing of death in relation to pregnancy</label>
                <select type="text" className='form-control rounded-3 w-70' value={TDTime} onChange={(e) => setTDTime(e.target.value)}>
                <option value="" selected disabled >-- Select--</option>
                 <option value="Antepartum">Antepartum</option>
                 <option value="Intra-partum">Intra-partum</option>
              ...
              <th>
              <div className='mb-2'>
                <h6><label htmlFor="email">If the deaths occur in post-partum/post-abortion, timing of death </label>
                  <input type="number" placeholder="Timing" autoComplete="off" name="prinata death" value={PostPartum} className='form-control justify-center rounded-lg w-70 text-3x1'
                    onChange={(e) => setPostPartum(e.target.value)} /></h6>
                </div>
              </th>
              </tr>
              </table>
        ...
        <div className='col-md-6 bg-light rounded p-0 border border-danger text-dark p-4 '>
          <h4 className='border border-secondary  rounded bgcoll text-white text-center'>Maternal Death Health Facility information</h4>
          <table className='border border-secondary Scrol-Table Scrol-Table table light padding table-responsive'>
            <tr>
            <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Reporting Health Facility name & type (HC/Clinic/Hospital)</label>
                  ...
                  <option value="" selected disabled >-- Select--</option>
                    ...
                    <option value="Privat clinic or hospital">Privat clinic or hospital</option>
            ...
            <th>
            <div className="col-md-10 form-group">
                    <h6><label htmlFor="email">This MDRF is extracted from</label>
                    <select type="text" className='form-control rounded-0 w-50' value={PDRF} onChange={(e)=> setPDRF(e.target.value)}>
                    <option value="" selected disabled >-- Select--</option>
                    <option value="Verbal autopsy (VA)">Verbal autopsy (VA)</option>
                    <option value="Facility based maternal death abstraction form (FBAF)">Facility based maternal death abstraction form (FBAF)</option>
                  </select>
                 </h6>
                    </div>
              </th>
        ...
        <h4 className='border border-secondary bgcoll text-white text-center rounded '>Addis Ababa Public Health Emergency Managment Maternal Death Reporting Format</h4>
          <table className='Scrol-Table Scrol-Table table light padding table-responsive'>
            <tr className='border border-secondary'>
            <th>
                <div className='mb-5'>
              ...
              <th>
                <div  className='form-check-inline'>
                  <h6>< label htmlFor="email">Attended ANC?</label><br></br>
                 <th className='p-2'><h6> Yes</h6> <input type="radio" name='ANC' value='Yes' className='p-4 mb-2' onClick={ ()=>setVisible(true)} onChange={(e) => setANC(e.target.value)}/></th>
                 <th className='p-2'><h6>No</h6><input type="radio" name='ANC' value='No' className='p-4 mb-2' onClick={ ()=>setVisible(false)} onChange={(e) => setANC(e.target.value)} /></th>
                 <th className='p-2'><h6>Not Known</h6><input type="radio" name='ANC' value='Not Known'onClick={ ()=>setvisited(true)} onChange={(e) => setANC(e.target.value)} /></th>
                 </h6>
                </div>
                {visible &&
                     <div className='mb-2'>
                      <h6><label htmlFor="email">If yes, where is the ANC?</label>
                      <select type="text" className='form-control rounded-2 w-75' value={WANC} onChange={(e)=> setWANC(e.target.value)}>
                      <option value="" selected disabled >-- Select--</option>
                    <option value="Health post">Health post</option>
                    <option value="Health Center">Health Center</option>
                    <option value="Hospital"> Hospital</option>
                       ...
                       {visible &&
                     <div className='mb-2'>
                      <h6><label htmlFor="email">If yes for ANC, number of visits?</label>
                      <input type="number" placeholder="ANC..." autoComplete="off" name="ANC.." value={NWANC} className='form-control justify-center rounded-lg w-70 text-3x1'
                       onChange={(e) => setNWANC(e.target.value)} /></h6>
                       </div>}
                       {visible &&
                     <div className='mb-2'>
                      <h6><label htmlFor="email">If yes, GA in months at the first ANC visits</label>
                      <input type="number" placeholder="ANC..." autoComplete="off" name="GANC.." value={GAANC} className='form-control justify-center rounded-lg w-70 text-3x1'
                       onChange={(e) => setGAANC(e.target.value)} /></h6>
                       </div>}
              </th>
              <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">If delivered, Mode of delivery? </label>
                  <select type="text" className='form-control rounded-2 w-75' value={Mode} onChange={(e)=> setMode(e.target.value)}>
                  <option value="" selected disabled >-- Select--</option>
                    <option value="Vaginal Delivery">Vaginal Delivery</option>
                    <option value="Abdominal Operated Delivery (CS or hysterectomy)"> Abdominal Operated Delivery (CS or hysterectomy)</option>
                  </select></h6>
                </div>
                </th>
                <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Place of delivery or Abortion?</label>
                <select type="text" className='form-control rounded-2 w-75' value={BabyBorn} onChange={(e)=> setBabyBorn(e.target.value)}>
                <option value="" selected disabled >-- Select--</option>
              ...
              <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Date of delivery / Abortion</label><br></br>
                  <DatePicker selected={DBabyBorn} onChange={(date) => setDBabyBorn(date)} 
                  dateFormat='dd/mm/yyyy'
                    maxDateDate={new Date()}
                    isClearable
                    showMonthDropdown
               ...
               <th>
                  ...
                  <h6>who assisted the delivery/Abortion</h6>
                  {Assisted}
                  </div>
                  <MultiSelect
                  value={Assisted}
                  Searchable
                  onChange={(e)=>(handleOnchangedelivery(e), setAssisted(e.target.value))}
              ...
              <th>
                <div  className='form-check-inline'>
                  <h6>< label htmlFor="email">Attended PNC/PAC?</label><br></br>
                 <th className='p-2'><h6> Yes</h6> <input type="radio" name='PNC' value='Yes'onClick={ ()=>setevisit(true)} onChange={(e) => setPNC(e.target.value)} /></th>
                 <th className='p-2'><h6>No</h6><input type="radio" name='PNC' value='No'onClick={ ()=>setevisit(false)} onChange={(e) => setPNC(e.target.value)} /></th>
                 <th className='p-2'><h6> Not Known</h6> <input type="radio" name='PNC' value='Not Known'onClick={ ()=>setvisit(true)} onChange={(e) => setPNC(e.target.value)} /></th>
                 <th className='p-2'><h6>Not Applicable</h6><input type="radio" name='PNC' value='Not Applicable'onClick={ ()=>setvisiting(true)} onChange={(e) => setPNC(e.target.value)} /></th>
                 
                 </h6>
                </div>
                {visite &&
                  <div className='mb-2'>
                  <h6><label htmlFor="email">If yes for PNC/PAC, number of visits?</label>
                  <input type="number" placeholder="PNC..." autoComplete="off" name="ANC.." value={TPNC} className='form-control justify-center rounded-lg w-70 text-3x1'
                 onChange={(e) => setTPNC(e.target.value)} /></h6>
                  </div>}
              </th>
              <th>
                <div className="app">
                <div  className="preview-values">
                <h6>Cause of Death (Direct obstetric)</h6>
                {DirectCauseD}
                </div>
                <MultiSelect
                value={DirectCauseD}
                Searchable
                onChange={(e)=>(handleOnchangeCause(e), setDirectCauseD(e.target.value))}
              ...
              <th>
                  <div className="col-md-10 form-group">
                    <h6><label htmlFor="email">If other direct cause, specify</label>
                  <input type="text" placeholder="Name of Region" autoComplete="off" name="Facility Name" value={TDirectCauseD} className='form-control rounded-2 w-75'
                    onChange={(e) => setTDirectCauseD(e.target.value)} /></h6>
                    </div>
                </th>
                <th>
                <div className="app">
                <div  className="preview-values">
                <h6>Cause of Death (Indirect obstetric)</h6>
                {IndirectCauseD}
                </div>
                <MultiSelect
                value={IndirectCauseD}
                Searchable
                onChange={(e)=>(handleOnchangeIn(e), setIndirectCauseD(e.target.value))}
                options={optionsIn}
                className='form-control rounded-3 w-100'
                  />           
              </div>
                ...
                <th>
                  <div className="col-md-10 form-group">
                    <h6><label htmlFor="email">If other indirect cause, specify </label>
                  <input type="text" placeholder="Name of Region" autoComplete="off" name="Facility Name" value={TIndirectCauseD} className='form-control rounded-2 w-75'
                    onChange={(e) => setTIndirectCauseD(e.target.value)} /></h6>
                    </div>
                </th>   
              <th>
                <div className='mb-2'>
                <h6> <label htmlFor="email">If delivered, what was the outcome ?</label>
              ...
              <tr className='border border-secondary'> 
                ...
                <h6><label htmlFor="email">Status of the baby at birth</label>
                  <select type="text" className='form-control rounded-2 w-75' value={Status} onChange={(e)=>(handleshowhide(e), setStatus(e.target.value))}>
                  <option value="" selected disabled >-- Select--</option>
                    <option value="12">Alive (live birth)</option>
                ...
                </div>
                {
                  ...
                  <input type="text" placeholder="APGAR" autoComplete="off" name="APGAR" value={TAliveAPGAR} className='form-control rounded-2 w-75'
                ...
                <h6><label htmlFor="email">Is the death preventable ?</label></h6><br></br>
                  <th className='p-2'><h6>Yes</h6><input type="radio" name='sample' value='Yes'onClick={ ()=>setvisitingA(true)} onChange={(e) => setpreventable(e.target.value)} /> </th>
                  <th className='p-2'><h6>No</h6><input type="radio" name='sample' value='No'onClick={ ()=>setvisitingA(false)} onChange={(e) => setpreventable(e.target.value)} /> </th>
                </div>
                </th>
              ...
              <th>
                ...
                value={Delay1}
                Searchable
                onChange={(e)=>(handleOnchangeD1(e), setDelay1(e.target.value))}
                options={optionsD1}
                className='form-control rounded-3 w-100'
                  />           
              </div>
              ...
              <th>
                ...
                value={Delay2}
                Searchable
                onChange={(e)=>(handleOnchangeD2(e), setDelay2(e.target.value))}
                options={optionsD2}
                className='form-control rounded-3 w-100'
                  />           
              </div>
              ...
              <th>
                ...
                value={Delay3}
                Searchable
                onChange={(e)=>(handleOnchangeD3(e), setDelay3(e.target.value))}
                options={optionsD3}
                className='form-control rounded-3 w-100'
                  />           
              </div>
                  ...
                  <input type="text" placeholder="Name equipment" autoComplete="off" name=" Name equipment" value={Supplies} className='form-control rounded-2 w-75'
