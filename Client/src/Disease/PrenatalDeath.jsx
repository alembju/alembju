...
///////////////////////////////////////////////////////////
  ...
  const [visibleeY, setVisibleeY]=useState(false);
...
console.log(values,"Cholera file is sent")
  ...
  //////////////////////////////////////////multiple selection Neonatal Cause of Death ////////////////////////

const  handleOnchangeNeo  =  val  => {
  setIndirectCauseNeo(val)
}
const  optionsNeo  = [
  { label:  'Asphyxia', value:  'Asphyxia'  },
  { label:  'Complications', value:  'Complications'  },
  { label:  'Lethal congenital anomaly', value:  'Lethal congenital anomaly'  },
  { label:  'Neonatal Tetanus', value:  'Neonatal Tetanus'  },
  { label:  'Sepsis/pneumonia /meningitis', value:  'Sepsis/pneumonia /meningitis'  },
]
  ...
  const  optionsD1  = [
    ...
    { label:  'Did not recognize the danger signs of newborn infants', value:  'Did not recognize the danger signs of newborn infants'  },
    { label:  'Unaware of the warning signs of problems during pregnancy', value:  'Unaware of the warning signs of problems during pregnancy'  },
    { label:  'Did not know wher to go', value:  'Did not know wher to go'  },
    { label:  'Had no one to take care of other children', value:  'Had no one to take care of other children'  },
    { label:  'Reliant to traditional practice / medicine', value:  'Reliant to traditional practice / medicine'  },
    { label:  'Lack of decision to go to the health facilityl', value:  'Lack of decision to go to the health facilityl'  },
  ]
...
const  optionsD2  = [
  { label:  'Transport was not available', value:  'Transport was not available'  },
  { label:  'Transport was too expensive', value:  'Transport was too expensive'  },
  { label:  'No facility within reasonable distance', value:  'No facility within reasonable distance'  },
  { label:  'lack of road access', value:  'lack of road access'  },
    ...
    <div className=' bgcoll    main-containers  '>
      ...
      <div class='row'>
        <div className=' col bg-light rounded border border-danger vh-1 text-dark p-4'>
          <h4 className='border border-secondary bgcoll text-white rounded text-center'>Prenatal Death patient information</h4>
         ...
         <th>
              ...
              <th>
                ...
                <h6><label htmlFor="email">Deceased Residency Woreda</label>
                  <select type="text" className='form-control rounded-3 w-50' value={PWoreda} onChange={(e)=>(handleshowhide(e),setPWoreda(e.target.value))}  >
                  <option value="" selected disabled >-- Select--</option>
             ...
             <th>
              ...
              <th>
                <div  className='form-check-inline'>
                 ...
                 <th className='p-1'><h6> Day</h6> <input type="radio" name='Sex' value='Day'onClick={ ()=>setVisible(true)} onChange={(e) => setDN(e.target.value)} /></th>
                 <th className='p-1'><h6>Night</h6><input type="radio" name='Sex' value='Night'onClick={ ()=>setVisible(false)} onChange={(e) => setDN(e.target.value)} /></th>
                 </h6>
                </div>
              </th>
              ...
              <th>
                <div  className='form-check-inline'>
                  <h6>< label htmlFor="email">Day | Night</label><br></br>
                 <th  className='p-1'><h6> Day</h6> <input type="radio" name='Sex' value='Day'onClick={ ()=>setevisit(true)} onChange={(e) => setPDN(e.target.value)} /></th>
                 <th  className='p-1'><h6>Night</h6><input type="radio" name='Sex' value='Night'onClick={ ()=>setevisit(false)} onChange={(e) => setPDN(e.target.value)} /></th>
                 </h6>
                </div>
              </th>
              <th>
              <div className='mb-2'>
                <h6><label htmlFor="email">Time of prinata death</label>
                  <input type="number" placeholder="prinata death" autoComplete="off" name="prinata death" value={TDTime} className='form-control justify-center rounded-lg w-70 text-3x1'
              ...
              <th>
                <div  className='form-check-inline'>
                 ...
                 <th  className='p-1'><h6> Male</h6> <input type="radio" name='Sex' value='Male'onClick={ ()=>setVisiblee(true)} onChange={(e) => setSex(e.target.value)} /></th>
                 <th  className='p-1'><h6>Female</h6><input type="radio" name='Sex' value='Female'onClick={ ()=>setVisiblee(false)} onChange={(e) => setSex(e.target.value)} /></th>
                 </h6>
                </div>
              </th>
              ...
              <div className='mb-2'>
                <h6><label htmlFor="email">Estimated gestational age at delivery in weeks </label>
                  <input type="number" placeholder="gestational..." autoComplete="off" name="gestational.." value={gestationalAge} className='form-control justify-center rounded-lg w-70 text-3x1'
              ...
              <th>
                <div  className='form-check-inline'>
                 ...
                 <th  className='p-1'><h6> Yes</h6> <input type="radio" name='Sex' value='Yes'onClick={ ()=>setvisited(true)} onChange={(e) => setMalive(e.target.value)} /></th>
                 <th  className='p-1'><h6>No</h6><input type="radio" name='Sex' value='No'onClick={ ()=>setvisited(false)} onChange={(e) => setMalive(e.target.value)} /></th>
                 </h6>
                </div>
              </th>
              <th>
              <div className='mb-2'>
                <h6><label htmlFor="email">Age of the mother (years)</label>
                  <input type="number" placeholder="mother..." autoComplete="off" name="mother.." value={MAge} className='form-control justify-center rounded-lg w-70 text-3x1'
              ...
              <th>
                ...
                <h6><label htmlFor="email">Parity</label>
                  <input type="number" placeholder="House Numbe Name" autoComplete="on" name="House Numbe" value={TParity} className='form-control justify-center rounded-lg w-70 text-3x1'
              ...
              <th>
                ...
                <h6><label htmlFor="email">Number of alive children </label>
                  <input type="number" placeholder="alive children" autoComplete="on" name="alive children" value={AliveChildren} className='form-control justify-center rounded-lg w-70 text-3x1'
        ...
        <div className='col-md-6 bg-light rounded p-0 border border-danger text-dark p-4 '>
          <h4 className='border border-secondary  rounded bgcoll text-white text-center'>Prinata Death Health Facility information</h4>
          <table className='border border-secondary Scrol-Table Scrol-Table table light padding table-responsive'>
            ...
            <div className="col-md-10 form-group">
                  ...
                  <input type="text" placeholder="Name of Woreda" autoComplete="off" name="Facility Name" value={PDRF} className='form-control justify-center rounded-lg w-70 text-3x1'
        ...
        <h4 className='border border-secondary bgcoll text-white text-center rounded '>Addis Ababa Public Health Emergency Managment Prinatal Death Reporting Format</h4>
          <table className='Scrol-Table Scrol-Table table light padding table-responsive'>
            <tr className='border border-secondary'>
            <th>
                <div className='mb-5'>
              ...
              <th>
                ...
                <h6> <label htmlFor="email">Number of ANC visits in relation to the deceased case (report)</label>
                  <input type="number" placeholder="ANC" autoComplete="off" name="ANC" value={ANC} className='form-control justify-center rounded-lg w-75 text-3x1'
                    onChange={(e) => setANC(e.target.value)} /></h6>
                </div>
              </th>
              <th>
                <div className='mb-2'>
                <h6> <label htmlFor="email">Number of TT vaccine during the pregnancy</label>
                <select type="text" className='form-control rounded-2 w-75' value={TTVaccine} onChange={(e)=> setTTVaccine(e.target.value)}>
                <option value="" selected disabled >-- Select--</option>
                    <option value="No TT">No TT</option>
                    <option value="One TT">One TT</option>
                    <option value="Two and above TT"> Two and above TT</option>
                    <option value="Unknown">Unknown</option>
                  </select></h6>
                </div>
              </th>
              <th>
                ...
                <h6><label htmlFor="email">Mode of delivery of the deceased baby </label>
                  ...
                  <option value="" selected disabled >-- Select--</option>
                    ...
                    <option value="Operative vaginal delivery">Operative vaginal delivery</option>
                    <option value="Vacuum">Vacuum</option>
                    <option value="Forceps"> Forceps</option>
                    <option value="C/S">C/S</option>
                    <option value="Not Known or Still Birth">Not Known or Still Birth</option>
                ...
                <h6><label htmlFor="email">Status of the baby at birth</label>
                  ...
                  <option value="" selected disabled >-- Select--</option>
                    <option value="10">Alive (live birth)</option>
              ...
              <th>
                ...
                <h6><label htmlFor="email">Maternal disease or condition identified</label>
                  <input type="text" placeholder="identified" autoComplete="off" name="identified" value={Maternal} className='form-control justify-center rounded-lg w-75 text-3x1'
              ...
              <th>
                ...
                <h6>Neonatal Cause of Death</h6>
                {Neonatal}
                </div>
                <MultiSelect
                value={Neonatal}
                Searchable
                onChange={(e)=>(handleOnchangeNeo(e), setNeonatal(e.target.value))}
                options={optionsNeo}
              ...
              <th>
                  ...
                  <input type="text" placeholder="Name of Region" autoComplete="off" name="Facility Name" value={TNeonatal} className='form-control rounded-2 w-75'
                ...
                <h6><label htmlFor="email">Maternal cause of death</label>
                  <select type="text" className='form-control rounded-2 w-75' value={CMaternal} onChange={(e)=>(handleshowhide(e), setCMaternal(e.target.value))}>
                  <option value="" selected disabled >-- Select--</option>
                    <option value="Obstructed labor">Obstructed labor</option>
                    <option value="Ruptured Uterus">Ruptured Uterus</option>
                    <option value="Preeclampsia/ Eclampsia"> Preeclampsia/ Eclampsia</option>
                    <option value="APH (Placenta Previa or abruption)">APH (Placenta Previa or abruption)</option>
                    <option value="Obstetric Sepsis">Obstetric Sepsis</option>
                ...
                </div>
                {
                  ...
                  <input type="text" placeholder="Name of Region" autoComplete="off" name="Facility Name" value={TCMaternal} className='form-control rounded-2 w-75'
                ...
                <div className="col-md-10 form-group">
                    ...
                    <select type="text" className='form-control rounded-2 w-75' value={TimingD} onChange={(e)=> setTimingD(e.target.value)}>
                    <option value="" selected disabled >-- Select--</option>
                    <option value="Antepartum stillbirth">Antepartum stillbirth</option>
                    <option value="Intrapartum stillbirth">Intrapartum stillbirth</option>
                    <option value="Death in the first 24 after birth">Death in the first 24 after birth</option>
                ...
                <h6><label htmlFor="email">Is the death preventable ?</label></h6><br></br>
                  <th  className='p-1'><h6>Yes</h6><input type="radio" name='sample' value='Yes'onClick={ ()=>setVisiblee(true)} onChange={(e) => setpreventable(e.target.value)} /> </th>
                  <th  className='p-1'><h6>No</h6><input type="radio" name='sample' value='No'onClick={ ()=>setVisiblee(false)} onChange={(e) => setpreventable(e.target.value)} /> </th>
                  <th  className='p-1'><h6>Unknown</h6><input type="radio" name='sample' value='Unknown'onClick={ ()=>setVisibleeY(true)} onChange={(e) => setpreventable(e.target.value)} /> </th>
                </div>
                </th>
                </tr>
              <tr className='border border-secondary'>
              <th>
                ...
                value={Delay1}
                Searchable
                onChange={(e)=>(handleOnchangeD1(e), Delay1(e.target.value))}
                options={optionsD1}
                className='form-control rounded-3 w-100'
                  />           
              </div>
              ...
              <th>
                ...
                value={Delay2}
                Searchable
                onChange={(e)=>(handleOnchangeD2(e), Delay2(e.target.value))}
                options={optionsD2}
                className='form-control rounded-3 w-100'
                  />           
              </div>
              ...
              <th>
                ...
                value={Delay3}
                Searchable
                onChange={(e)=>(handleOnchangeD3(e), Delay3(e.target.value))}
                options={optionsD3}
                className='form-control rounded-3 w-100'
                  />           
              </div>
              ...
              <th>
                ...
                <h6><label htmlFor="email">EPI_Week</label>
                  <select type="text" className='form-control justify-center rounded-lg w-70 text-3x1' value={EPIWeek} onChange={(e)=>setEPIWeek(e.target.value)}>
                  <option value="" selected disabled >-- Select--</option>
                    { EPI_Week .map(Ctr => (
