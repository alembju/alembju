...
function Fistula  () {
  ...
  const [NLivingC,setNLivingC]=useState()
  const [BabyBorn,setBabyBorn] = useState("")
  const [Mode,setMode] =useState("")
  const [TypeF,setTypeF]=useState("")
  const [Outcome,setOutcome] = useState("")
  const [TimingOF, setTimingOF] = useState("")
  const [ANC,setANC]=useState('')
  const [ANCK,setANCK]=useState("")
  const [WANC,setWANC]=useState("")
  const [TWANC,setTWANC]=useState("")
  const [TANC,setTANC]=useState("")
  const [Cause,setCause]=useState("")
  const [TCause,setTCause]=useState("")
...
const submitImage = async (e) => {
  ...
  formData.append("NLivingC", NLivingC);
  formData.append("BabyBorn", BabyBorn);
  formData.append("Mode", Mode);
  formData.append("TypeF", TypeF);
  formData.append("Outcome", Outcome);
  formData.append("TimingOF", TimingOF);
  formData.append("ANC", ANC);
  formData.append("ANCK", ANCK);
  formData.append("WANC", WANC);
  formData.append("TWANC", TWANC);
  formData.append("TANC", TANC);
  formData.append("Cause", Cause);
  formData.append("TCause", TCause);
    ...
    <div className=' bgcoll    main-containers  '>
      ...
      <div class='row'>
        <div className=' col bg-light rounded border border-danger vh-1 text-dark p-4'>
          <h4 className='border border-secondary bgcoll text-white rounded text-center'>Obstetric fistula patient information</h4>
          <table className='Scrol-Table Scrol-Table table light padding table-responsive'>
        <tr className='border border-secondary'>
         <th>
         <div className='mb-2 form-check-inline'>
                <h6> <label htmlFor="email">Unique IDN</label><br></br>
                <input type="Number" placeholder="ID" autoComplete="off" name="ID" value={ID} className='form-control justify-center rounded-lg w-70 text-3x1'
         ...
         <th>
                ...
                <h6><label htmlFor="email">Age at Death (Days)</label>
                  <input type="bumber" placeholder="Age" autoComplete="off" name="Age" value={Age} className='form-control justify-center rounded-lg w-70 text-3x1'
              ...
              <div className='mb-2'>
                <h6><label htmlFor="email">Kebele | Ketena</label>
                  <input type="number" placeholder="Ketena" autoComplete="off" name="Ketena" value={Kebele} className='form-control justify-center rounded-lg w-70 text-3x1'
        ...
        <div className='col-md-6 bg-light rounded p-0 border border-danger text-dark p-4 '>
          <h4 className='border border-secondary  rounded bgcoll text-white text-center'>Obstetric fistula Health Facility information</h4>
        ...
        <h4 className='border border-secondary bgcoll text-white text-center rounded '>Addis Ababa Public Health Emergency Managment Obstetric fistula Reporting Format</h4>
          <table className='Scrol-Table Scrol-Table table light padding table-responsive'>
            <tr className='border border-secondary'>
            <th>
                <div className='mb-2'>
              ...
              <th>
              <div className='mb-2'>
                <h6><label htmlFor="email">Number of living children</label>
                  <input type="number" placeholder="living children" autoComplete="off" name="living children" value={NLivingC} className='form-control justify-center rounded-lg w-70 text-3x1'
                    onChange={(e) => setNLivingC(e.target.value)} /></h6>
                </div>
              </th>
              <th>
                <div className='mb-2'>
              ...
              <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Mode of delivery</label>
                ...
                <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Type of obstetrics fistula</label>
                <select type="text" className='form-control rounded-2 w-75' value={TypeF} onChange={(e)=>setTypeF(e.target.value)}>
                <option value="" selected disabled >-- Select--</option>
                    <option value="Vesico-vaginal">Vesico-vaginal</option>
                    <option value="Recto-vaginal">Recto-vaginal</option>
                    <option value="Urethro-vaginal">Urethro-vaginal</option>
                  </select></h6>
                </div>
              </th>
              </tr>
              ...
              <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Outcome of delivery</label>
                ...
                <option value="" selected disabled >-- Select Outcome-- </option>
                    <option value="Alive birth">Alive birth</option>
              ...
              <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Timing Obstetric fistula occur after index delivery</label>
                <select type="text" className='form-control rounded-2 w-75' value={TimingOF} onChange={(e)=> setTimingOF(e.target.value)}>
            ...
            <th>
                <div  className='form-check-inline'>
                 ...
                 <th  className='p-3'><h6> Yes</h6> <input type="radio" name='Sex' value='Yes'onClick={ ()=>setVisible(true)} onChange={(e) => setANC(e.target.value)} /></th>
                 <th  className='p-3'><h6>No</h6><input type="radio" name='Sex' value='No'onClick={ ()=>setVisible(false)} onChange={(e) => setANC(e.target.value)} /></th>
                 <th className='p-3'><h6>Not known</h6><input type="radio" name='Sex' value='Not known'onClick={ ()=>setevisit(false)} onChange={(e) => setANCK(e.target.value)} /></th>
                 </h6>
                </div>
                {visible &&
                     <div className='mb-2'>
                      <h6><label htmlFor="email">If yes, where is the ANC?</label>
                      <select type="text" className='form-control rounded-2 w-75' value={WANC} onChange={(e)=>(handleshowhide(e), setWANC(e.target.value))}>
                      <option value="" selected disabled >-- Select-- </option>
                    <option value="Health post">Health post</option>
                    <option value="Health center">Health center</option>
                    <option value="Hospital"> Hospital</option>
                  ...
                  <input type="text" placeholder="ANC" autoComplete="off" name="ANC" value={TWANC} className='form-control rounded-2 w-75'
                    onChange={(e) => setTWANC(e.target.value)} /></h6>
                    </div>
                  )}   
                  {visible &&
                     <div className='mb-2'>
                      <h6><label htmlFor="email">If yes, number of ANC visits</label>
                      <input type="number" placeholder="ANC" autoComplete="off" name="ANC" value={TANC} className='form-control rounded-2 w-75'
                    onChange={(e) => setTANC(e.target.value)} /></h6>
                       </div>}
              </th>
              <th>
                <div className='mb-2'>
                <h6><label htmlFor="email">Cause of obstetric fistula</label>
                  <select type="text" className='form-control rounded-2 w-75' value={Cause} onChange={(e)=>(handleshowhide(e), setCause(e.target.value))}>
                  <option value="" selected disabled >-- Select Cause-- </option>
                    ...
                    <option value="Operative delivery"> Operative delivery</option>
                ...
                {showhide==='9' && (
                  <div className="col-md-10 form-group">
                    <h6><label htmlFor="email">If other specify</label>
                  <input type="text" placeholder="ANC" autoComplete="off" name="ANC" value={EPIWeek} className='form-control rounded-2 w-75'
                    onChange={(e) => setTCause(e.target.value)} /></h6>
                    </div>
                  )}   
                </th>
                <th>
                ...
                <th>
                  ...
                  value={Delay3}
                  Searchable
                  onChange={(e)=>(handleOnchangeD3(e), setDelay2(e.target.value))}
                  options={optionsD3}
                  className='form-control rounded-2 w-100'              
                   />             
                  </div>
